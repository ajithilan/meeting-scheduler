...
import { calendarStyling } from '../styling/calendarStyling';
...
export const TimeDateInput = ()=>{
    ...
    return <div className="flex flex-col items-start time-date-input py-[30px]">
        <h1 className="text-[18px] font-extrabold pl-8">Select a Date & Time</h1>
        <div className="">
            ...
            <section className='timezone px-5'>
